...
from airflow.sdk._shared.observability.metrics import otel_compat_logger
from airflow.sdk.configuration import conf

if TYPE_CHECKING:
    from airflow.sdk._shared.observability.metrics.otel_compat_logger import OtelCompatStatsdLogger
